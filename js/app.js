...
(function() {
    ...
    var elRandomQuoteButton = document.querySelector('button.random-quote')
        elQuoteContainer = document.querySelector('.quote'),
        elAuthor = document.querySelector('.author');
 
    // We call the function once outside the function.
